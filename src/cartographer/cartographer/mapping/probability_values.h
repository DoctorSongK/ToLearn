...
constexpr uint16 kUpdateMarker = 1u << 15; // 32768                      // 加上kUpdateMarker作为一个标志, 代表这个栅格已经被更新了
