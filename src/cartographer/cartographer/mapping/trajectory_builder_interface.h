...
/**
 * @brief TrajectoryBuilderInterface是个接口类,没有具体实现，包含添加所有传感器数据等接口
...
class TrajectoryBuilderInterface {
 public:
  /**
   * @param node_id           节点id（包含节点id 轨迹id）
   * @param constant_data     前端匹配所用数据（点云，local位姿）
   * @param insertion_submaps 插入的子图信息
   */
