...
// c++11: std::lround 返回最接近x的long int整数(实际作用如四舍五入) eg: lround(15.2) -> 15, lround(15.8) -> 16
// 返回最接近x的整数
 ...
 */
// c++11: static_cast、dynamic_cast、const_cast、reinterpret_cast的适用场景
// static_cast: 一般情况下类型转换
// const_cast:  可以在某些情况下用来去除const属性
// dynamic_cast: 用于具备继承关系之间的转换
// const_cast: 用来处理无关类型之间的转换，其会产生一个新的值，这个值会有与原始参数有完全相同的比特位
