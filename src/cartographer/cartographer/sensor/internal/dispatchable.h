...
// 使用模版的意义就是针对odom、imu、lidar等数据均可做处理, 通过MakeDispatchable完成实例化
...
class Dispatchable : public Data {
 public:
  ...
  // core: 传感器数据处理流程step5->这里根据模版DataType不同，调用trajectory（collated_trajectory_builder）中不同的AddSensorData函数
