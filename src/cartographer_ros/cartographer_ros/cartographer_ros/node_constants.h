...
constexpr char kLaserScanTopic[] = "scan";              //scan
constexpr char kMultiEchoLaserScanTopic[] = "echoes";   //多超声雷达
constexpr char kPointCloud2Topic[] = "points2";         //点云
constexpr char kImuTopic[] = "imu";                     //IMU
constexpr char kOdometryTopic[] = "odom";               //ODOM
constexpr char kNavSatFixTopic[] = "fix";               //GPS
constexpr char kLandmarkTopic[] = "landmark";           //LANDMARK
